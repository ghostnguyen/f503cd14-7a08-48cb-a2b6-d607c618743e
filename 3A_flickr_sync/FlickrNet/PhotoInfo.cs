...
namespace _3A_flickr_sync.FlickrNet
{
    ...
    public sealed class PhotoInfo : IFlickrParsable
    {
        ...
        public string OwnerBuddyIcon
        {
            get
            {
                return Helper.BuddyIcon(OwnerIconServer, OwnerIconFarm, OwnerUserId);
            }
        }
        ...
        {
            get { return Helper.UrlFormat(this, "_n", "jpg"); }
        }
        ...
        {
            get { return Helper.UrlFormat(this, String.Empty, "jpg"); }
        }
        ...
        {
            get { return Helper.UrlFormat(this, "_z", "jpg"); }
        }
        ...
        {
            get { return Helper.UrlFormat(this, "_c", "jpg"); }
        }
        ...
        {
            get { return Helper.UrlFormat(this, "_b", "jpg"); }
        }
        ...
        {
            get { return Helper.UrlFormat(this, "_q", "jpg"); }
        }
        ...
        public string OriginalUrl
        {
            get
            {
                ...
                return Helper.UrlFormat(this, "_o", OriginalFormat);
            }
        }
        ...
        private void ParseDates(System.Xml.XmlReader reader)
        {
            while (reader.MoveToNextAttribute())
            {
                ...
                {
                    case "posted":
                        DatePosted = Helper.UnixTimestampToDate(reader.Value);
                        break;
                    case "taken":
                    ...
                    case "takengranularity":
                        ...
                        break;
                    case "lastupdate":
                        DateLastUpdated = Helper.UnixTimestampToDate(reader.Value);
                        break;
                    default:
                        Helper.CheckParsingException(reader);
                        break;
